                    ...
                    <div class="row">
                        ...
                        <main class="col-md-10 ms-sm-auto px-md-4">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-4">
                                <h2>Trainers</h2>
                                <a href="/admin/trainer/create" class="btn btn-primary">+ New Trainer</a>
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Assigned Trainees</th>
                                    ...
                                    <tbody>
                                        <c:forEach items="${trainers}" var="trainer">
                                            <tr>
                                                ...
                                                <td>
                                                    <c:forEach items="${trainer.trainee}" var="trainee">
                                                        ${trainee.user.fullName}
                                                    </c:forEach>
                                                </td>
                                                <td>
                                                    <c:choose>
                                                        <c:when test="${trainer.activationStatus eq 'true'}">
                                                ...
                                                <td class="table-actions">
                                                    <a href="/admin/trainer/update/${trainer.id}"
                                                        class="btn btn-sm btn-primary">Edit</a>
                                                    <a href="/admin/trainer/delete/${trainer.id}"
