                        ...
                        <main class="col-md-10 ms-sm-auto px-md-4 ">
                            <div class="container">
                                <div class="col-12 mx-auto">
                                    <h3 class="d-flex justify-content-between align-items-center mt-4">Update Trainee
                                    </h3>
                                    <form:form method="post" action="/admin/trainee/update"
                                        modelAttribute="updateTrainee" enctype="multipart/form-data">
                                        <div class="row g-3">
                                            ...
                                            <div class="col mb-3">
                                                <label for="exampleInputEmail1" class="form-label disable">Email
                                                    address</label>
                                                <form:input type="email"
                                                    class="form-control ${not empty errorEmail ? 'is-invalid':''}"
                                                    path="user.email" disable="disable" />
                                                ${errorEmail}
                                            </div>
                                            <div class="col mb-3">
